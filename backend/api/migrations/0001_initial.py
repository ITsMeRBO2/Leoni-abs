...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Employee',
            fields=[
                ('mle', models.CharField(max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='SaturdayConfiguration',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(unique=True)),
                ('families_off', models.JSONField(default=list)),
            ],
        ),
        migrations.CreateModel(
            name='Settings',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('rh', 'RH')], default='rh', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='api.employee')),
            ],
        ),
        migrations.CreateModel(
            name='ImportHistory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('Present', 'Présent'), ('Absent', 'Absent'), ('Repos', 'Repos')], max_length=20)),
